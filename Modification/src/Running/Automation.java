...
public class Automation {
	static String username = "vasudha"; // Your username
...
//	driver.findElement(By.xpath(".//a[contains(text(),'Sign in')]")).click();s
...
//	driver.quit();
	...
	ReadExcelSheet res=new ReadExcelSheet("C:\\SampleAccountValidation.xlsx");
